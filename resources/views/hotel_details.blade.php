            ...
            <section class="group mb-10 grid grid-cols-1 gap-3 lg:grid-cols-2 lg:gap-4">
                ...
                <div class="grid h-64 grid-cols-2 grid-rows-2 gap-3 sm:h-80 lg:h-[420px]">
                    @for ($slot = 0; $slot < 4; $slot++)
                        ...
                        <div @class([ 'relative overflow-hidden rounded-2xl' , 'bg-gray-200'=> $isUsedSlot,
                            ])>
                            @if ($isSeeMoreSlot)
    ...
    <x-animate-in delay="200">
        <section class="relative w-full overflow-hidden bg-blue-400 py-12 sm:py-24">
            <div class="relative mx-auto w-full max-w-[1600px] px-2 sm:px-3 md:px-4 lg:px-6">
                <div class="flex flex-col items-center gap-10 px-6 sm:px-8 lg:flex-row lg:items-center lg:gap-16 lg:px-10">

                    {{-- Texto + botón --}}
                    <div class="flex flex-col gap-5 max-w-xl">
                        <span class="w-fit inline-block rounded-md bg-green-300/15 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-green-200">
                            Para agencias
                        </span>
                        <h2 class="text-2xl font-extrabold leading-snug text-white sm:text-5xl">
                        ...
                        <a
                            ...
                            class="mt-2 self-start rounded-lg bg-green-300 px-7 py-3.5 text-xl font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:opacity-90 hover:shadow-md">
                            Regístrate
                        </a>
                    </div>

                    {{-- Grid de imágenes --}}
                    <div class="group hidden flex-col items-center gap-4 lg:flex lg:flex-1">
                        <div class="h-48 w-full overflow-hidden rounded-3xl xl:h-64">
                            <img
                                src="{{ asset('images/home/frame1.webp') }}"
                                alt="Viajes Travel Logic"
                                class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
                        </div>
                        <div class="grid w-full grid-cols-3 gap-4">
                            <div class="h-32 overflow-hidden rounded-3xl xl:h-40">
                                <img
