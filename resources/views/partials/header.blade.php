...
<header class="sticky top-0 left-0 right-0 z-50 bg-white shadow-md">
    <!-- SPACE WITH LINK TO PORTAL -->
    <div class="w-full h-9 bg-blue-4 grid grid-cols-2 items-center">
        <div class="ml-14">
            <p class="text-white text-xs font-normal font-lato">🌍 Operadora Mayorista · México y el Caribe</p>
        </div>

        <div class="flex gap-6 justify-end mr-14">
            <a class="text-white text-xs font-normal font-inter">Soporte 24/7</a>
            <div class="flex items-center gap-2 justify-end">
                <a class="text-green-4 text-xs font-semibold font-inter">Ingresa al Portal</a>
                <x-lucide-arrow-right class="w-4 h-4 text-green-4" />
