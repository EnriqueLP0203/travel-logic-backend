...
<div>
    <form
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-end md:gap-5">
            ...
            <button type="button" class="flex items-center gap-2 w-full border-2 border-gray-200 shrink-0 rounded-lg px-8 py-2.5 font-semibold text-black transition-colors duration-200 hover:bg-green-100 md:w-auto">
                Playa
            </button>
            <button type="button" class="flex items-center gap-2 w-full border-2 border-gray-200 shrink-0 rounded-lg px-8 py-2.5 font-semibold text-black transition-colors duration-200 hover:bg-green-100 md:w-auto">
                Ciudad
