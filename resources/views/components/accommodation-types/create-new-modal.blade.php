...
<div
    ...
    <div class="relative z-10 flex w-full max-w-4xl flex-col rounded-lg bg-white shadow-xl">
        ...
        <form
            method="POST"
            action="{{ route('admin.accommodation-types.store') }}"
            class="flex flex-col"
            ...
            {{-- Cuerpo: izq. nombre/estado · der. icono --}}
            <div class="grid grid-cols-1 gap-8 px-6 py-6 md:grid-cols-2">
                ...
                {{-- Columna derecha: icono + buscador --}}
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center gap-2">
                        <div
                            ...
                            <x-lucide-image class="size-5 text-slate-300" data-icon-preview-placeholder />
                        </div>
