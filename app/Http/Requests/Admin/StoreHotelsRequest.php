...
class StoreHotelsRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'hotel_detail_id' => $this->filled('hotel_detail_id') ? $this->input('hotel_detail_id') : null,
            'hotel_code' => $this->filled('hotel_code') ? $this->input('hotel_code') : null,
            'supplier_id' => $this->filled('supplier_id') ? $this->input('supplier_id') : null,
            'supplier_name' => $this->filled('supplier_name') ? $this->input('supplier_name') : null,
        ]);
    }
}
