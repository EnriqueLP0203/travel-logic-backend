...
{
    private const DIRECTORY = 'travel_media/destinations';
    ...
    public function store(UploadedFile $file, string $city): array
    {
        ...
        try {
            ...
            if (! rename($tempPath, $originalPath)) {
                throw new RuntimeException('No se pudo preparar la imagen del destino.');
            }
            $tempPath = null;
