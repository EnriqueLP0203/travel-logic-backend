...
{
    private const DIRECTORY = 'travel_media/offers';
    ...
    public function store(UploadedFile $file, string $offerName): array
    {
        ...
        try {
            ...
            if (! rename($tempPath, $originalPath)) {
                throw new RuntimeException('No se pudo preparar la imagen de la oferta.');
            }
            $tempPath = null;
